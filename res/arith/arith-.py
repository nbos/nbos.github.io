...
group_A_min_label_width_frac = 0.03  # Only show labels if segment width >= this fraction
...
group_B_min_label_width_frac = 0.04  # Only show labels if segment width >= this fraction
