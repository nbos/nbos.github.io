...
powers_A = [7,8,9]  # which powers to show for group A
...
powers_B = [3,2]  # which powers to show for group B

# ----------------- Zoom Parameters -----------------
zoom_start = 0.5703125  # start of zoom range [0, 1]
zoom_end = 0.578125    # end of zoom range [0, 1]
...
highlight_bounds = (0.57421875,0.576265) # interval in original coordinates where highlight appears
highlight_color = 'red'
