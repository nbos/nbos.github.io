...
powers_A = [2,3,4]  # which powers to show for group A
...
highlight_bounds = (0.5, 0.5625)  # interval in original coordinates where highlight appears
highlight_color = 'red'
