...
powers_A = [5,6,7]  # which powers to show for group A
...
powers_B = [2]  # which powers to show for group B

# ----------------- Zoom Parameters -----------------
zoom_start = 0.5625  # start of zoom range [0, 1]
zoom_end = 0.59375    # end of zoom range [0, 1]
...
group_A_min_label_width_frac = 0.06  # Only show labels if segment width >= this fraction
...
highlight_bounds = (0.5703125,0.578125)  # interval in original coordinates where highlight appears
highlight_color = 'red'
