...
powers_A = [2,3]  # which powers to show for group A
...
# ----------------- Zoom Parameters -----------------
zoom_start = 0.25  # start of zoom range [0, 1]
zoom_end = 0.75    # end of zoom range [0, 1]
...
group_A_min_label_width_frac = 0.07  # Only show labels if segment width >= this fraction
...
group_B_min_label_width_frac = 0.08  # Only show labels if segment width >= this fraction
...
highlight_bounds = (4/9, 16/27)  # interval in original coordinates where highlight appears
highlight_color = 'red'
...
plt.tight_layout()
plt.savefig('ABA-arith-phase.svg')
# plt.show()
