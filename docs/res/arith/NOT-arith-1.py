...
powers_A = [3,4,5]  # which powers to show for group A
...
powers_B = [2,1]  # which powers to show for group B

# ----------------- Zoom Parameters -----------------
zoom_start = 0.5  # start of zoom range [0, 1]
zoom_end = 0.625    # end of zoom range [0, 1]
...
highlight_bounds = (0.5625, 0.59375)  # interval in original coordinates where highlight appears
highlight_color = 'red'
