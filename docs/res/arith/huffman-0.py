...
powers_A = [1,2,3]  # which powers to show for group A

h = 0.5
alphabet_B = [
    ('A',h**4),('C',h**5),('D',h**5),('E',h**3),('G',h**5),
    ('H',h**5),('I',h**4),('L',h**4),('M',h**5),('P',h**5),
    ('N',h**4),('O',h**4),('R',h**4),('S',h**4),('T',h**3),
    ('B',h**6),('F',h**6),('U',h**5),('V',h**6),('W',h**6),
    ('Y',h**6),('K',h**7),('Q',h**8),('X',h**9),('J',h**10),
    ('Z',h**10)
]
...
zoom_end = 0.5    # end of zoom range [0, 1]
...
highlight_bounds = (0.0, 6.25e-2)  # interval in original coordinates where highlight appears
highlight_color = 'red'
highlight_linewidth = 8
