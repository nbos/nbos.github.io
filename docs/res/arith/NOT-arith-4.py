...
powers_A = [9,10,11]  # which powers to show for group A
...
# ----------------- Zoom Parameters -----------------
zoom_start = 0.57421875  # start of zoom range [0, 1]
...
group_B_min_label_width_frac = 0.07  # Only show labels if segment width >= this fraction
...
highlight_bounds = (0.57568359375,0.576265) # interval in original coordinates where highlight appears
highlight_color = 'red'
