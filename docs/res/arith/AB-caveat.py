...
powers_A = [1,2]  # which powers to show for group A
...
highlight_bounds = (0.0, 0.25)  # interval in original coordinates where highlight appears
highlight_color = 'red'
