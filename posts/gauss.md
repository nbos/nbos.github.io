...
are generated between $n = 1$ and $n = 100$ reproducing the plot from an
earlier section:
...
Nearly identical results are generated by sampling from a
[**normal**](https://en.wikipedia.org/wiki/Normal_distribution)
distribution with the same variance $(\sigma^2 = 8.\overline{3})$:

![](images/randomnormal.png)

Sampling from any wider distributions produce code lengths closer to the
